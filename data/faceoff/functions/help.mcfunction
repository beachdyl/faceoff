...
tellraw @p {"text":" ","color":"aqua"}
tellraw @p {"text":"Drop a Command Block to open the Admin Panel. It is much easier to use than these legacy commands.","color":"gold"}
tellraw @p {"text":" ","color":"aqua"}
...
tellraw @p [{"text":"twist -","color":"gold"},{"text":" Program this world to use a game twist, which must be set up in the twists.mcfunction file beforehand.","color":"yellow"}]
tellraw @p [{"text":"go -","color":"gold"},{"text":" Starts the match. No new players may join after this command is run.","color":"yellow"}]
...
tellraw @p {"text":" ","color":"aqua"}
tellraw @p [{"text":"Drop a ","color":"gold"},{"text":"[Command Block]","color":"gold","italic":false,"clickEvent":{"action":"run_command","value":"/give @p command_block"}},{"text":" to open the Admin Panel. It is much easier to use than these legacy commands.","color":"gold"}]
tellraw @p {"text":" ","color":"aqua"}
tellraw @p {"text":"This is the help documentation for the faceoff data pack!","color":"light_purple"}

...
# mild strain
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=1,virustime=1700}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"You don't feel well.","color":"yellow"},{"text":" You might have caught something."}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=1,virustime=3250}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> You have caught the Mild strain of the "},{"text":"Faceoff Virus.","color":"yellow"}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=1,virustime=7400}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Be careful","color":"yellow"},{"text":" who you come into contact with."}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=1,virustime=12000}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> Your symptoms are gone, but "},{"text":"the virus is not.","color":"yellow"}]
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=1,virustime=14400}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> You are now immune to the "},{"text":"Faceoff Virus.","color":"yellow"}]

# severe strain
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=2,virustime=1500}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"You don't feel well.","color":"yellow"},{"text":" You might have caught something."}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=2,virustime=3000}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> You have caught the Severe strain of the "},{"text":"Faceoff Virus.","color":"yellow"}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=2,virustime=4500}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Be very careful","color":"yellow"},{"text":" who you come close to."}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=2,virustime=6400}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"You should stay grounded ","color":"yellow"},{"text":"for the time being."}]
...
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=2,virustime=9600}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> Your symptoms are gone, but "},{"text":"the virus is not.","color":"yellow"}]
execute if score virusenabled global matches 1 run tellraw @a[scores={infected=2,virustime=11000}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> You are now immune to the "},{"text":"Faceoff Virus.","color":"yellow"}]

...
tellraw @r[scores={haunt=..-1}] [{"text":"[7] -","color":"gold","clickEvent":{"action":"run_command","value":"/trigger haunt set 7"}},{"text":" Cause a random healthy player to glow briefly. (5 Haunt Points)","color":"yellow"}]
tellraw @r[scores={haunt=..-1}] {"text":" ","color":"gold"}
...
# haunts
## 1
tellraw @r[scores={haunttime=0..2331,haunt=8,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]
...
## 2
tellraw @r[scores={haunttime=0..3497,haunt=2,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]
...
## 3
tellraw @r[scores={haunttime=0..3497,haunt=3,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]
...
## 4
tellraw @r[scores={haunttime=0..1165,haunt=4,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]
...
## 5
tellraw @r[scores={haunttime=0..6995,haunt=5,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]
...
## 6
tellraw @r[scores={haunttime=0..4663,haunt=6,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]
...
## 7
tellraw @r[scores={haunttime=0..5829,haunt=7,mobkills=1..,playersleft=3..}] [{"text":"<"},{"text":"Miguel","color":"aqua"},{"text":"> "},{"text":"Error!","color":"red"},{"text":" You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!"}]

...
# 4
tellraw @r[scores={haunttime=0..1165,haunt=4,mobkills=1..,playersleft=3..}] {"text":"You do not have enough Haunt Points for this haunt yet. Wait for your points to increase!","color":"red"}
